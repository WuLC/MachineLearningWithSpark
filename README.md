[Machine Learning With Spark](https://play.google.com/store/books/details?pcampaignid=books_read_action&id=syPHBgAAQBAJ)对应的 Jupyter Notebook, 书中代码大部分是 Scala，这里全部通过 python 编写
